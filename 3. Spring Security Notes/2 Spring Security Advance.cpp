...
→ Disadvantages:
  • Credentials are sent on every requestm, High Risk
...
→ How CSRF Attacks Work:
  ...
  • Browser includes JSESSIONID, making the request valid.
...
→ Backend must define and allow other domains to access its resources.
